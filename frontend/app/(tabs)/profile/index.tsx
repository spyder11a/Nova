      ...
      >
        ...
        >
          {isDarkMode ? (
            ...
            <Svg width="34" height="34" viewBox="0 0 34 34" fill="none">
              <Path
                d="M17 4.25C14.4783 4.25 12.0132 4.99777 9.91649 6.39876C7.81976 7.79975 6.18556 9.79103 5.22054 12.1208C4.25552 14.4505 4.00303 17.0141 4.49499 19.4874C4.98695 21.9607 6.20127 24.2325 7.98439 26.0156C9.76751 27.7987 12.0393 29.013 14.5126 29.505C16.9859 29.997 19.5495 29.7445 21.8792 28.7795C24.209 27.8144 26.2003 26.1802 27.6012 24.0835C29.0022 21.9868 29.75 19.5217 29.75 17C29.75 16.3483 29.6933 15.6967 29.6083 15.0733C28.9004 16.0658 27.9651 16.8744 26.8806 17.4314C25.7962 17.9884 24.5941 18.2777 23.375 18.275C21.7532 18.275 20.1733 17.7599 18.8632 16.804C17.5531 15.8481 16.5805 14.5007 16.0856 12.9563C15.5907 11.4118 15.5992 9.75011 16.1099 8.2108C16.6205 6.67149 17.6068 5.33415 18.9267 4.39167C18.3033 4.30667 17.6517 4.25 17 4.25Z"
                fill="#FCFCFC"
              />
            </Svg>
          )}
        ...
        <View style={styles.frame109} testID="1270:78">
          <View style={styles.frame108} testID="1270:79">
            ...
            <View style={styles.frame1082} testID="1272:165">
              <View style={styles.frame103} testID="1272:166">
                <Text
                  style={[styles.$3642K, { color: theme.text_primary }]}
                  testID="1272:167"
                >
                  {creditScore}
                </Text>
                <Text
                  style={[styles.creadits, { color: theme.text_primary }]}
                  testID="1272:168"
                >
                  {`Creadits`}
                </Text>
              ...
              <View
                style={[styles.frame112, { backgroundColor: theme.background }]}
                testID="1272:169"
              >
                <ImageBackground
              ...
              <View style={styles.frame104} testID="1272:171">
                <Text
                  style={[styles.$231, { color: theme.text_primary }]}
                  testID="1272:172"
                >
                  {`4`}
                </Text>
                <Text
                  style={[styles.posts, { color: theme.text_primary }]}
                  testID="1272:173"
                >
                  {`Posts`}
                </Text>
          ...
          <View style={styles.group33} testID="1270:91">
            <View style={styles.frame102} testID="1270:92">
              <Text
                style={[styles.$0Xc5G4444, { color: theme.text_primary }]}
                testID="1270:93"
              >
                {`${address.slice(0, 10)}...${address.slice(-3)}`}
              </Text>
              <Text
                style={[styles.kai06, { color: theme.text_primary }]}
                testID="1270:94"
              >
                {`@greg_hisenberg`}
              </Text>
        ...
        <View style={styles.frame110}>
          <View style={styles.frame3}>
            <Pressable
              style={[styles.frame35,{borderBottomColor: theme.text_primary}, selected === 1 && styles._frame35,{borderBottomColor: theme.text_primary}]}
            ...
            >
              <Svg width={20} height={20} viewBox="0 0 20 20" fill="none">
                <Path
                  ...
                  fill={isDarkMode? (
                    selected == 1 ? "white" : "#868686"
                  ):(
                    selected == 1 ? "#181C1F" : "#DDDDDD"
                  )}
                />
              </Svg>
            </Pressable>
            <Pressable
              style={[styles.frame35,{borderBottomColor: theme.text_primary}, selected === 2 && styles._frame35,{borderBottomColor: theme.text_primary}]}
            ...
            >
              <Svg width="19" height="19" viewBox="0 0 19 19" fill="none">
                <Path
                  ...
                  fill={isDarkMode? (
                    selected == 2 ? "white" : "#868686"
                  ):(
                    selected == 2 ? "#181C1F" : "#DDDDDD"
                  )}
                />
              </Svg>
            </Pressable>
            ...
            <>
              {claim == 1 ? (
                ...
                >
                  <View style={[styles.frame132]} testID="1348:221">
                    <View style={styles.frame120} testID="1348:222">
                      <View style={[styles._frame117]} testID="1348:223">
                        <Text
                          style={[styles.posted, { color: theme.primary }]}
                          testID="1348:224"
                        >
                          {`Claim`}
                        </Text>
                  ...
                  <View style={styles.frame118} testID="1348:229"></View>
                </TouchableOpacity>
              ) : (
                <View style={styles.__frame129} testID="1348:220">
                  <View style={styles.frame132} testID="1348:221">
                    <View style={styles.frame120} testID="1348:222">
                      <View style={styles.frame117} testID="1348:223">
                        <Text
                          style={[styles.posted, { color: theme.text_primary }]}
                          testID="1348:224"
                        >
                          {"Claimed"}
                        </Text>
                  ...
                  <View style={styles.frame118} testID="1348:229">
                    <Text
                      style={[styles.now, { color: theme.text_secondary }]}
                      testID="1348:230"
                    >
                      {`now`}
                    </Text>
              ...
              <View
                style={[styles.frame129, { backgroundColor: theme.primary }]}
                testID="1348:220"
              >
                <View style={styles.frame132} testID="1348:221">
                  <View style={styles.frame120} testID="1348:222">
